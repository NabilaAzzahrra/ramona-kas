                        ...
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <form action="{{ route('pendapatan.update', $pendapatan->id) }}" method="post">
                                ...
                                <div class="p-4 rounded-xl">
                                    ...
                                    <button type="submit"
                                        class="text-white bg-[#0C4B54] hover:bg-[#0c3454] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Simpan</button>
                                </div>
                            </form>
                        </div>
                    </div>

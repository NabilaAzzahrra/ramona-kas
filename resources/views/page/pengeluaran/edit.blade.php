                                    ...
                                    <div class="flex gap-5">
                                        <div class="mb-5 w-full">
                                            ...
                                            <select
                                                ...
                                                <option value="{{ $pengeluaran->id_jenis_pengeluaran }}">
                                                    {{ $pengeluaran->jenis_pengeluaran->jenis_pengeluaran }}</option>
                                                @foreach ($jenis_pengeluaran as $m)
                                                    @if ($m->id != $pengeluaran->id_jenis_pengeluaran)
                                            ...
                                            <span
                                                class="text-sm m-l text-red-500">{{ $errors->first('pengeluaran') }}</span>
                                        </div>
                                        <div class="mb-5 w-full">
                                            <label for="uraian"
                                            ...
                                            <input type="text" id="uraian" name="uraian"
                                                ...
                                                placeholder="Masukan Uraian disini ..." value="{{$pengeluaran->item_pengeluaran}}" required />
                                        </div>
                                    </div>
                                    <div class="flex gap-5">
                                        <div class="mb-5 w-full">
                                            ...
                                            <input type="text" id="keterangan" name="keterangan"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Masukan Keterangan disini ..." value="{{$pengeluaran->keterangan}}" required />
                                        </div>
                                        <div class="mb-5 w-full">
                                            ...
                                            <input type="number" id="pengeluaran" name="pengeluaran"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Masukan Pengeluaran disini ..." value="{{$pengeluaran->pengeluaran}}" required />
                                        </div>
                                        <div class="mb-5 w-full" hidden>
                                            <label for="pengeluaran_awal"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pengeluaran awal</label>
                                            <input type="number" id="pengeluaran_awal" name="pengeluaran_awal"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
